...
#insert_dft
             ...
             write_icc2_files -output ../results/msr32_top -force

write -hierarchy -format ddc -output ../results/msr32_top.ddc 
report_area > ../reports/msr32_top.rpt
report_hierarchy > ../reports/msr32_top.rpt
report_design > ../reports/msr32_top.rpt
report_timing -path full > ../reports/msrv32_top.rpt
write -hierarchy -format verilog -output ../results/msrv32_top.v
write_sdf  ../reports/msr32_top.sdf
